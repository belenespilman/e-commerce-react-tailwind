...
const AppRoutes = () => {
 ...
 const isUserSignOut = context.signOut || parsedSignOut
  ...
  let routes = useRoutes([
    ...
    { path: '/my-orders/last', element: hasUserAnAccount && !isUserSignOut ? <MyOrders /> : <Navigate replace to={'sign-in'} />  },
    { path: '/my-orders/:id', element: hasUserAnAccount && !isUserSignOut ? <MyOrders /> : <Navigate replace to={'sign-in'} />  },
